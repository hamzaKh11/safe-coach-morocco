      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to="/" className="text-foreground hover:text-primary font-medium transition-colors px-3 py-2 rounded-lg hover:bg-accent/10">
              الرئيسية
            </Link>
            <Link to="/explore" className="text-foreground hover:text-primary font-medium transition-colors px-3 py-2 rounded-lg hover:bg-accent/10 flex items-center gap-2">
              <Search className="w-4 h-4" />
              استكشاف التقارير
            </Link>
            <Link to="/submit" className="text-foreground hover:text-primary font-medium transition-colors px-3 py-2 rounded-lg hover:bg-accent/10 flex items-center gap-2">
          ...
          <div className="md:hidden py-6 border-t border-white/10 bg-white/95 backdrop-blur-xl">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-3 pt-6 border-t border-white/10 mt-4">
                <Button variant="ghost" size="lg" asChild className="justify-start rounded-xl">
